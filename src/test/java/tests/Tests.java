	 ...
	 private static APICalls apiCalls;
	    ...
	    public void checkEachFibNumberInSequence() {
		    ...
		    for(int i=0; i<100; i++) {
		    	...
		    	endIndex++;
	    	    testIndex++;
	    	    System.out.println("Index values are:  " + startIndex + " " + endIndex + " " + testIndex);
		        ...
		        System.out.println("Index1 = " + actualIndex1and2.get(0) + " and Index2 = "  + actualIndex1and2.get(1)); 
		        System.out.println("actualTestValue = " + actualIndex3Value);
